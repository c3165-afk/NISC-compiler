...
def schedule_bb_alap(cdfg, bb_id, operators, state_offset=0):
    ...
    for node_id in topo_order:  # ← revervedを外す
        ...
        while True:
            if state_usage[state][resource_key] < operator.count:
                break
            state += 1
